// Component to store the applications state
import React, { createContext, useContext, useEffect, useReducer } from "react"

// interface describing appState value
...
// initialize the cart object to empty
...
export const useStateDispatch = () => {
    ...
    if (!dispatch) {
        throw new Error("useState was called outside the AppSetStateContext provider")
    }
    return dispatch
}
